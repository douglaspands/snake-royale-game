...
**Active Specification Version:** `v1.4.0-HUD-LAYOUT`  
...
| :--- | :--- | :--- | :--- |
| [`SPEC-v1.4.0-VIPER-HUD.md`](file:///home/douglas/Workspace/claude/snake-game/specs/SPEC-v1.4.0-VIPER-HUD.md) | Client HUD & Layout | 3-Corner ergonomic HUD, unified `LENGTH/MASS` stats row, bottom-right Canvas radar. | [`openspec/changes/v1.4.0-hud-layout/specs/hud.delta.md`](file:///home/douglas/Workspace/claude/snake-game/openspec/changes/v1.4.0-hud-layout/specs/hud.delta.md) |
...
- **v1.4.0-HUD-LAYOUT (Current):** 3-Corner ergonomic HUD redistribution (Top-Right: Leaderboard, Bottom-Left: Vital Stats, Bottom-Right: Radar/Minimap), unified `LENGTH/MASS: <tamanho> / <massa>` single-row stat format.
- **v1.3.0-COMBAT-POLISH:** Universal Double-Tap & Hold Turbo gesture (tablet/mobile), 12+ vibrant mixed/bicolor skins, clock-synchronized anti-jitter interpolator, pure-contact collision physics (no self-collision), and Token Efficiency guidelines.
